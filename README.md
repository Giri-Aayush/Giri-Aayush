...
- Authored [SNIP-27](https://github.com/starknet-io/SNIPs/blob/main/SNIPS/snip-27.md), the Starknet Monetary Committee Charter, merged into starknet-io/SNIPs
- Five merged PRs to [starknet.go](https://github.com/NethermindEth/starknet.go/pulls?q=is%3Apr+author%3AGiri-Aayush): v0.17.0 release documentation, docs fixes, landing page redesign
...
- Sponsor prize, ETHGlobal HackFS 2022 (XMTP, Lenster)

## Background

Blockchain researcher at [IIT (ISM) Dhanbad](https://cse.iitism.ac.in/). Engineering internships at Jio (WebRTC, JioMeet) and Rize Labs (account abstraction wallets). Day to day: Rust, TypeScript, Go, Python, Solidity, Cairo.
